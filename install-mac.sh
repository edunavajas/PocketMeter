...
SERVICE_LABEL="com.user.pocketmeter-ble-daemon"
...
DAEMON_PY="$SCRIPT_DIR/daemon/pocketmeter_ble_daemon.py"
LOG_DIR="$HOME/Library/Logs"
LOG_OUT="$LOG_DIR/pocketmeter-ble-daemon.out.log"
LOG_ERR="$LOG_DIR/pocketmeter-ble-daemon.err.log"
...
echo "  3. Click 'Connect' next to the device currently advertised as 'Claude Controller'."
echo "  4. The daemon will discover it within ~30 s and start polling."
echo ""
echo "Useful commands:"
echo "  launchctl list | grep pocketmeter-ble  # check it's running"
